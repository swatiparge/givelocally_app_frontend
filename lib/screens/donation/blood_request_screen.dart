...
class _BloodRequestScreenState extends ConsumerState<BloodRequestScreen> {
  ...
  Future<void> _pickFile() async {
    ...
    if (result != null)
      setState(() => _requisitionFile = File(result.files.single.path!));
  }
  ...
  Future<void> _submitRequest() async {
    ...
    if (_requisitionFile == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Please upload doctor's requisition")),
      );
      return;
    }
    ...
    try {
      ...
      final payload = {
        "data": {
          ...
          "description":
              "Hospital: ${_hospitalController.text}. Ward: ${_wardController.text}. ${_descController.text}",
          "images": [proofUrl],
          "condition": "new",
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: _inputDeco(
                  "e.g. Reason for urgency, patient name...",
                ),
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              "SECURE REQUEST: Doctor's note required",
              style: TextStyle(
                fontSize: 12,
                fontWeight: FontWeight.bold,
                color: Colors.blue,
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        return InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: isSel ? const Color(0xFFE53935) : Colors.white,
              borderRadius: BorderRadius.circular(25),
              border: Border.all(
                color: isSel ? const Color(0xFFE53935) : Colors.grey.shade200,
              ),
            ),
            child: Center(
              child: Text(
  ...
  Widget _buildHospitalInput(
    ...
    return TextFormField(
      ...
      decoration: _inputDeco(
        hint,
      ).copyWith(prefixIcon: Icon(icon, color: Colors.grey.shade600, size: 20)),
      validator: (v) =>
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              _requisitionFile == null
                  ? "Upload Doctor's Requisition"
                  : "File Uploaded ✓",
